        ...
        <div class="row">
            <form action="/taxi/create" method="post">
                ...
                <div class="form-group">
                    <label for="origen">Tipo de Taxi</label>
                    <select class="form-control" id="tipo" name="tipo">
                        <option value="4" selected>Taxi Normal (4 Cupos)</option>
                        <option value="7">Taxi Grande (7 Cupos)</option>
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select class="form-control" id="pasajeros" name="pasajeros">
                        ...
                        <option value="4" class="tc">4 [Taxi Completo]</option>
                        <option value="4" class="hide tg">4</option>
                        <option value="5" class="hide tg">5</option>
                        <option value="6" class="hide tg">6</option>
                        <option value="7" class="hide tg">7 [Taxi Completo]</option>
                    </select>
                </div>
                <div class="form-group">
    ...
    <script>
        $(function () {
            ...
            $('#date').on('dp.change', function (e) {
                $("#realdate").val(e.date.format("YYYY-MM-DD HH:mm:ss"));
            });
            $.ajax({
                url: "/api/locations",
                type: "get",
