...
<header class="main-header">
    ...
    <a href="{{ url('/home') }}" class="logo">
        ...
        <span class="logo-mini"><img src="/img/logomini.png" style="width: 80%"></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><img src="/img/logoweb.png" width="100%" ></span>
    </a>
                    ...
                    <li class="dropdown user user-menu" id="user_menu" style="max-width: 280px;white-space: nowrap;">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                <div>
                                    <a href="{{ url('/logout') }}" class="btn btn-danger btn-flat btn-block" id="logout"
